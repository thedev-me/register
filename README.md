...
**IMPORTANT NOTE:** In no world will you keep all the records listed in this example. Only keep the ones you need. [Learn more about DNS records.](https://www.cloudflare.com/learning/dns/dns-records/)
